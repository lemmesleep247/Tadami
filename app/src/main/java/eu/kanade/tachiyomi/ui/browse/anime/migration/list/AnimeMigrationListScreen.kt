...
import eu.kanade.tachiyomi.ui.browse.anime.migration.config.AnimeMigrationConfigScreenSheet
...
class AnimeMigrationListScreen(
    ...
    override fun Content() {
        ...
        val screenModel = rememberScreenModel {
            AnimeMigrationListScreenModel(animeIds, sourceIds, extraSearchQuery)
        }
        ...
        LaunchedEffect(matchOverride) {
            ...
            screenModel.useAnimeForMigration(current = current, target = target)
            matchOverride = null
        }
        ...
        AnimeMigrationListScreenContent(
            ...
            onSearchManually = { navigator.push(MigrateAnimeSearchScreen(it.anime.id)) },
            onCancelSearch = screenModel::cancelSearch,
            onSkip = screenModel::removeAnime,
