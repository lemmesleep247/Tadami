...
fun NovelMigrationConfigScreenSheet(
    ...
    val migrationFlags by preferences.migrationFlagsNovel().collectAsState()
            ...
            Column(
                ...
                FlowRow(
                    ...
                    MigrationFlagChip(
                        ...
                        onClick = {
                            preferences.migrationFlagsNovel().set(migrationFlags xor CHAPTERS)
                        },
                    )
                    MigrationFlagChip(
                        ...
                        onClick = {
                            preferences.migrationFlagsNovel().set(migrationFlags xor CATEGORIES)
                        },
                    )
                    MigrationFlagChip(
                        ...
                        onClick = {
                            preferences.migrationFlagsNovel().set(migrationFlags xor DELETE_DOWNLOADED)
                        },
                    )
                }
