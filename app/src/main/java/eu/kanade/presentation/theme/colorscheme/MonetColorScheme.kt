        ...
        private fun generateColorSchemeFromSeed(context: Context, seed: Int, dark: Boolean): ColorScheme {
            ...
            return if (dark) {
                darkColorScheme(
                    ...
                    primaryFixed = dynamicColors.primaryFixed().getArgb(scheme).toComposeColor(),
                    primaryFixedDim = dynamicColors.primaryFixedDim().getArgb(scheme).toComposeColor(),
                    onPrimaryFixed = dynamicColors.onPrimaryFixed().getArgb(scheme).toComposeColor(),
                    onPrimaryFixedVariant = dynamicColors.onPrimaryFixedVariant().getArgb(scheme).toComposeColor(),
                    secondaryFixed = dynamicColors.secondaryFixed().getArgb(scheme).toComposeColor(),
                    secondaryFixedDim = dynamicColors.secondaryFixedDim().getArgb(scheme).toComposeColor(),
                    onSecondaryFixed = dynamicColors.onSecondaryFixed().getArgb(scheme).toComposeColor(),
                    onSecondaryFixedVariant = dynamicColors.onSecondaryFixedVariant().getArgb(scheme).toComposeColor(),
                    tertiaryFixed = dynamicColors.tertiaryFixed().getArgb(scheme).toComposeColor(),
                    tertiaryFixedDim = dynamicColors.tertiaryFixedDim().getArgb(scheme).toComposeColor(),
                    onTertiaryFixed = dynamicColors.onTertiaryFixed().getArgb(scheme).toComposeColor(),
                    onTertiaryFixedVariant = dynamicColors.onTertiaryFixedVariant().getArgb(scheme).toComposeColor(),
                )
            } else {
                lightColorScheme(
                    primary = dynamicColors.primary().getArgb(scheme).toComposeColor(),
