...
class AnimeScreenLayoutTest {

    @Test
    fun `metadata loading keeps plugin cover for classic anime screen`() {
        ...
        resolveCoverUrl(state, AnimeMetadataSource.ANILIST) shouldBe "https://example.org/plugin-cover.jpg"
    }
}
